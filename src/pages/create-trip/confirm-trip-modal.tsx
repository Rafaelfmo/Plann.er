          ...
          <div className="w-[640px] rounded-xl px-6 py-5 shadow-shape bg-zinc-900 space-y-5">
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <button type="button">
                        <X onClick={closeConfirmTripModal} className="size-5 text-zinc-400"></X>
                        </button>
                    </div>
                ...
                <form onSubmit={createTrip} className="space-y-3">
                    ...
                    <button type="submit" className="bg-lime-300 text-lime-950 rounded-lg px-5 h-11 font-medium flex items-center gap-2 hover:bg-lime-400 w-full justify-center">Confirmar criação de viagem<Plus className="size-5 text-line-950"></Plus></button>
                </form>
            </div>
        </div>
    )
